  ...
  var visitor = {
    ...
    JSXOpeningElement: function JSXOpeningElement(path, state) {
      ...
      if (state.file && state.file.opts) {
        ...
        newAttributes.push(t.jSXAttribute(t.jSXIdentifier(componentAttr), t.jSXExpressionContainer(t.logicalExpression('&&', t.memberExpression(t.identifier('window'), t.identifier('__DEBUG')), t.logicalExpression('&&', t.memberExpression(t.memberExpression(t.identifier('window'), t.identifier('__DEBUG')), t.identifier(defaultDebugProperty)), t.stringLiteral(source))))));
      }
